// src/main/java/uz/kundalik/telegram/payload/weather/HourDto.java
...
public class HourDto {
    ...
    private double snowCm; // Qo'shildi
    ...
    private int willItSnow; // Qo'shildi
    @JsonProperty("chance_of_snow")
    private int chanceOfSnow; // Qo'shildi
    @JsonProperty("vis_km")
